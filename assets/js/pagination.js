...
(function ($, window, document, undefined) {
    ...
    var LuckmoshyPagination = function (element, options) {
        ...
        $('#totpages').val(this.options.totalPages);
...
onPageClick: function (event, page) {
	var totpage = $('#totpages').val();
	var curpage = (parseInt(totpage) + 1 - page);
	var postyear = (curpage + 2010);
	$('#postyear').text(postyear);
	$('.page-active').removeClass('page-active');
	$('#post-pagnation'+curpage).addClass('page-active');
},
